        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StartForm = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DaysOff_DayOffTypes_DayOffTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DaysOffPull = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DayOffUser_Users_UsersId",
                        column: x => x.UsersId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Requests_DayOffTypes_DayOffTypeId",
                        column: x => x.DayOffTypeId,
                        principalTable: "DayOffTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DaysOff_DayOffTypeId",
                table: "DaysOff",
                column: "DayOffTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Requests_DayOffTypeId",
                table: "Requests",
                column: "DayOffTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Responses_DayOffTypeId",
                table: "Responses",
                column: "DayOffTypeId");
